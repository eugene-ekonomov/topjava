...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 29, 10, 0), "Завтрак", 1000),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 29, 13, 0), "Обед", 500),
            new Meal(1, LocalDateTime.of(2015, Month.MAY, 29, 20, 0), "Ужин", 510),
